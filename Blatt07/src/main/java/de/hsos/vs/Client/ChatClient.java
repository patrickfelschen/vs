...
public class ChatClient {
    ...
    /**
     * Bei gültigem Input wird ein neuer Client-Proxy erstellt, welcher im Chat-Proxy als Kommunikationsschnittstelle
     * für den Nachrichtenaustausch dient (Nachrichten ausgeben).
     * Über das zurückgelieferte ChatProxy Element aus der subscribeUser() Funktion des Servers, wird eine
     * Kommunikation zwischen Server und Client ermöglicht (Nachrichten verteilen).
    ...
    /**
     * Die Server-Funktion unsubscribeUser() wird ausgeführt, wodurch der Nutzer aus
     * der Liste der aktiven Verbindungen ausgetragen wird.
     */
